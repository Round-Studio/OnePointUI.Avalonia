...
namespace OnePointUI.Avalonia.Style.Core
{
    ...
    {
        // 预定义的主题色
        private static readonly Dictionary<string, Color> PredefinedColors = new Dictionary<string, Color>
        {
        ...
        /// 获取预定义的主题色列表
        /// </summary>
        public static ReadOnlyDictionary<string, Color> Colors => new ReadOnlyDictionary<string, Color>(PredefinedColors);
        ...
        private static bool _isApplyingColor = false;
